 ...
 * <p>
 * SqlSessionFactoryBean是“SqlSessionFactory”的工厂，实现了org.springframework.beans.factory.InitializingBean接口，
 * 在Spring初始化时候调用InitializingBean接口#afterPropertiesSet方法完成初始化工作
 *
